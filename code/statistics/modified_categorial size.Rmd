...
for (x in c("A", "B")){
  for (i in c(1000, 5000, 10000)){
    ...
    write.xlsx(archi_joint_df, file.path(path_to_data, "results",  sprintf("%s_%s_cs joint archi.xlsx", x, as.character(i))))
    write.xlsx(archi_mw_results, file.path(path_to_data, "results", sprintf("%s_%s_cs results archi.xlsx", x, as.character(i))))
    
    write.xlsx(non_archi_joint_df, file.path(path_to_data, "results", sprintf("%s_%s_cs joint non archi.xlsx", x, as.character(i))))
    write.xlsx(non_archi_mw_results, file.path(path_to_data, "results", sprintf("%s_%s_cs results non archi.xlsx", x, as.character(i))))
  }
}
